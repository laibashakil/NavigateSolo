...
export default function NavigationApp() {
      ...
      try {
        ...
        if (query.toLowerCase().includes("auditorium")) {
          results = [{
            ...
            geometry: { type: "Point", coordinates: [67.112123, 24.932170] }
          }];
        }      
    ...
    const fetchRoute = async () => {
      ...
      if (destination === "NED University Auditorium, Karachi") {
        destCoords = [67.112123, 24.932170];  // Hardcoded Auditorium coords 
      } else {
        ...
        destCoords = geoData.features[0].geometry.coordinates;
      }
