...
import haversine from "haversine";  // npm install haversine
...
export default function NavigationApp() {
    ...
    const checkNextStep = (userCoords, routeSteps) => {
        ...
        const distanceToNext = haversine(userCoords, userLocation, { unit: "meter" });
    ...
    return (
        <View className="flex-1 bg-gray-100 p-1">
            ...
            <View className="border border-gray-300 rounded-lg bg-white">
                <Picker selectedValue={selectedDestination} onValueChange={(itemValue) => setSelectedDestination(itemValue)}>
